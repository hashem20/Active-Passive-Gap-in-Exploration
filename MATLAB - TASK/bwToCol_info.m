classdef bwToCol_info < handle
    ...
    methods
        ...
        function obj = bwToCol_info(bwDir, colDir, bgColour)
            if exist('bwDir') == 1
                obj.bwDir = bwDir;
            end
            if exist('colDir') == 1
        ...
        function convertNumbers(obj, col, nMin, nMax, str)
        ...
        function convertAll(obj, col, dbFlag)
            ...
            obj.convertNumbers(col{1}*0.5, 1, 100, 'g')
