...
%horizon task    
    ...
    methods
        function obj = task_horizon2(window,savename,bgColour)
...
%               i=i+1; ev{i} = 'L_77';       iStr{i} = 'If you play this gampling wisely and earn enough points, you will be able to finish the task within 20 minutes. However, if you just choose randomly, your task will last about 40 minutes. Try your best to get as many points as you can!';
                ...
                i = i+1; ev{i} = 'forcedL1';     iStr{i} = 'Then, the fixation cross will disappear and the bandits will appear - like this ... during this period feel free to look where you want to.';
                i = i+1; ev{i} = 'free';        iStr{i} = 'Then, a GO cue will appear at which point you need to choose between the two options';
