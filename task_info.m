classdef task_info < handle
    ...
    methods
        ...
        function obj = task_info(stimdir, sounddir, datadir, savename)
        ...
        function makeGameParameters(obj)
            ...
            % info condition - 0 is no feedback, 1 is partial feedback
            var(i).x = [0 1];
            var(i).type = 1;
            i=i+1;
            
            [var, T, N] = counterBalancer(var, 5);
        ...
        function freeTrial(obj, Lrew, Rrew, rewHistL, rewHistR, infoCond)
            ...
            switch KeyNum
                ...
                case 1 % chose left
                    ...
                    switch infoCond
                        case 0
                            rewHistL.addReward(rewQQ);
                            obj.banL.showRewardPlayed([rewQQ]);
                        case 1
                ...
                case 2 % chose right
                    ...
                    switch infoCond
                        case 0
                            rewHistR.addReward(rewQQ);
                            obj.banR.showRewardPlayed([rewQQ]);
                        case 1
                            rewHistR.addReward(rew(reward));
                            obj.banR.showRewardPlayed([rew(Lrew)]);
                    end
        ...
        function playGame(obj, game)
            ...
            for i = 1:nFree
                ...
                obj.freeTrial(Lrew(trialNum), Rrew(trialNum), rewHistL, rewHistR, infoCond);
                obj.storeData;
